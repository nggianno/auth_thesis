...
PATH_TO_TRAIN = '/home/ubuntu/django-api/gru4rec/June0119dataset.csv'
PATH_TO_TEST = '/home/ubuntu/django-api/gru4rec/June0119testset.csv'
...
if __name__ == '__main__':
    ...
    with tf.Session(config=gpu_config) as sess:
        ...
        if args.is_training:
            ...
            topN.to_csv('/home/ubuntu/django-api/gru4rec/top_products_gru2.csv')
